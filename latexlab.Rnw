...
\section{Abstract}
A report detailing the performance of a simple regression analysis, based on the examples given in chapter 3 of the book \emph{An Introduction to Statistical Learning}. In this report, we reproduce some of the graphics and statistics included in that chapter.
